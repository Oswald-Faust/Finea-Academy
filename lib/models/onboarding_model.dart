  ...
  static List<OnboardingPage> getPages() {
    return [
      ...
      const OnboardingPage(
        ...
        imagePath: "assets/images/notif-removebg-preview.png",
        pageIndex: 1,
        keyFeatures: [],
      ),
      const OnboardingPage(
        ...
        imagePath: "assets/images/hands-checker-removebg-preview.png",
        pageIndex: 2,
      ...
      const OnboardingPage(
        ...
        imagePath: "assets/images/diplome-removebg-preview.png",
        pageIndex: 3,
      ...
      const OnboardingPage(
        ...
        imagePath: "assets/images/cerrtificate-removebg-preview.png",
        pageIndex: 4,
      ...
      const OnboardingPage(
        ...
        imagePath: "assets/images/mail-removebg-preview.png",
        pageIndex: 6,
      ...
      const OnboardingPage(
        ...
        imagePath: "assets/images/calculatrice-removebg-preview.png",
        pageIndex: 7,
